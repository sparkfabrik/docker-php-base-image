...
build-7-1-11-rootless: build-test-image
	docker build -t sparkfabrik/php-base-image:7.1.11-fpm-alpine3.4-rootless --build-arg user=1001 7.1.11-fpm-alpine3.4
...
build-7-1-12-rootless: build-test-image
	docker build -t sparkfabrik/php-base-image:7.1.12-fpm-alpine3.4-rootless --build-arg user=1001 7.1.12-fpm-alpine3.4
...
build-7-1-22-rootless: build-test-image
	docker build -t sparkfabrik/php-base-image:7.1.22-fpm-alpine3.8-rootless --build-arg user=1001 7.1.22-fpm-alpine3.8
...
build-7-1-29-rootless: build-test-image
	docker build -t sparkfabrik/php-base-image:7.1.29-fpm-alpine3.9-rootless --build-arg user=1001 7.1.29-fpm-alpine3.9
...
build-7-2-0-rootless: build-test-image
	docker build -t sparkfabrik/php-base-image:7.2.0-fpm-alpine3.7-rootless --build-arg user=1001 7.2.0-fpm-alpine3.7
...
build-7.2.25-rootless: build-test-image
	docker build -t sparkfabrik/php-base-image:7.2.25-fpm-alpine3.10-rootless --build-arg user=1001 7.2.25-fpm-alpine3.10
...
build-7-3-24-rootless: build-test-image
	docker build -t sparkfabrik/php-base-image:7.3.24-fpm-alpine3.12-rootless --build-arg user=1001 7.3.24-fpm-alpine3.12
...
build-7-4-6-rootless: build-test-image
	docker build -t sparkfabrik/php-base-image:7.4.6-fpm-alpine3.10-rootless --build-arg user=1001 7.4.6-fpm-alpine3.10
...
build-7-4-16: build-test-image
	docker build -t sparkfabrik/php-base-image:7.4.16-fpm-alpine3.13 7.4.16-fpm-alpine3.13
	./tests/tests_wrapper.sh php7 sparkfabrik/php-base-image:7.4.16-fpm-alpine3.13 root

build-7-4-16-rootless: build-test-image
	docker build -t sparkfabrik/php-base-image:7.4.16-fpm-alpine3.13-rootless --build-arg user=1001 7.4.16-fpm-alpine3.13
	./tests/tests_wrapper.sh php7 sparkfabrik/php-base-image:7.4.16-fpm-alpine3.13-rootless "unknown uid 1001"
